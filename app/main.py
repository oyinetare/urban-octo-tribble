...
from app.routes import agent, auth, documents, memory, metrics, query, users
...
app.include_router(agent.router, prefix="/api/v1/agent", tags=["Agents"])
app.include_router(memory.router, prefix="/api/v1/agent/memory", tags=["agent-memory"])
